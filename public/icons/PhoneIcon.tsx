...
export default function PhoneIcon({
  color = "#1C274C",
  size = 32,
  hoverColor = "#ffffffcc", // blanco fantasmal
}: PhoneIconProps) {
  return (
    <svg
      class="transition duration-300 hover:scale-110 cursor-pointer"
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill={color}
      ...
      onMouseEnter={(e) => ((e.currentTarget as SVGElement).style.fill = hoverColor)}
      onMouseLeave={(e) => ((e.currentTarget as SVGElement).style.fill = color)}
    >
